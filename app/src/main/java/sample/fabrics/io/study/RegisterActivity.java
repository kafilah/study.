...
public class RegisterActivity extends AppCompatActivity implements LoaderCallbacks<Cursor> {
    ...
    private void attemptLogin() {
        ...
        //decided to cancel their log in request
        if (cancel) {
    ...
    /**
     * This method makes sure that the email passed in is valid
     * might want to make this type checking more specific?
     * @param email
     * @return
     */
    //i understand
    ...
    /**
     * This method makes sure the password passed in is valid
     * might want to add more type checking
     *
     * @param password
     * @return
     */
